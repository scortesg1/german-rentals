...
import { CarListUserProps } from "./CarListUser.types";
...
export default function CarListUser(props: CarListUserProps) {
  const { cars } = props;
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-8 my-4 lg:grid-cols-3 2xl:grid-cols-4 h-full">
      {cars.map((car: Car) => {
        const {
          pricePerDay,
          photo,
